...
milliseconds = 0
write_file = "CalibrationCameraLocation"+str(start)+".csv"
d = 0
real_measurement = 0
error = 0
...
with open(write_file, "wt", encoding="utf-8") as output:
    ...
    #skeleton detection
            ...
            real_measurement = 300
            error = d - real_measurement


        output.write(str(start_time.strftime("%H:%M:%S")) + ',' + str(d) + ',' + str(real_measurement) + ',' + str(error) + '\n')
